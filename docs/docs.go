...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/assignments": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "ID устройства и автомобиля",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "устройство или автомобиль не найдены либо принадлежат другой организации",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    },
                    "409": {
                        "description": "устройство или автомобиль уже заняты",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    }
        ...
        "/drivers": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "От даты создания (RFC3339)",
                        "name": "created_from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "До даты создания (RFC3339)",
                        "name": "created_to",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Лимит записей (по умолчанию 100, максимум 500)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
        ...
        "/drivers/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "у водителя есть рейсы, удаление невозможно",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    }
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "также возвращается, если в теле передан organization_id",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.OrgRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RegisterOrganizationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/telemetry": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "ID водителя (для роли DRIVER игнорируется и подставляется свой)",
                        "name": "driver_id",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "number",
                        "description": "Минимальный уровень топлива",
                        "name": "fuel_min",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "description": "Максимальный уровень топлива",
                        "name": "fuel_max",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "От даты (RFC3339)",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "До даты (RFC3339)",
                        "name": "to",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "роль DRIVER без привязанного водителя",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Точка телеметрии",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.TelemetryRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "автомобиль не найден или принадлежит другой организации",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    }
        ...
        "/trips": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "От даты начала (RFC3339)",
                        "name": "started_from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "До даты начала (RFC3339)",
                        "name": "started_to",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "number",
                        "description": "Минимальная средняя скорость",
                        "name": "min_avg_speed",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "description": "Максимальная средняя скорость",
                        "name": "max_avg_speed",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "description": "Минимальная макс. скорость",
                        "name": "min_max_speed",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "description": "Максимальная макс. скорость",
                        "name": "max_max_speed",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "ID водителя и автомобиля",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "водитель или автомобиль не найдены либо принадлежат другой организации",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    }
        ...
        "/trips/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Новый статус (COMPLETED, CANCELLED)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "dto.RegisterOrganizationRequest": {
            "type": "object",
            "properties": {
                "admin_email": {
                    "type": "string"
        ...
        "dto.UpdateTripRequest": {
            ...
            "properties": {
                "status": {
                    "$ref": "#/definitions/model.TripStatus"
                }
            }
        },
        "dto.UpdateVehicleRequest": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/model.VehicleStatus"
                }
            }
        },
        "dto.UserResponse": {
        ...
        "model.AlertRuleType": {
            ...
            "x-enum-varnames": [
                "AlertRuleSpeedExceed",
                "AlertRuleDeviceOffline",
                "AlertRuleLowFuel"
            ]
        },
        "model.AuthResult": {
        ...
        "model.VehicleStatus": {
            ...
            "x-enum-varnames": [
                "VehicleStatusIdle",
                "VehicleStatusOnTrip",
                "VehicleStatusInService",
                "VehicleStatusDeleted"
            ]
        }
    },
    "securityDefinitions": {
